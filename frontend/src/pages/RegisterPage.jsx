...
export default function ReportsPage({ setPage, setActiveDraft, handleBack, user }) {
    ...
    const generateMultiLengthReport = (acceptedData, rejectedData, fileName) => {
 ...
 const generateSingleLengthReport = (reportData, fileName) => {
         const wb = XLSX.utils.book_new();
